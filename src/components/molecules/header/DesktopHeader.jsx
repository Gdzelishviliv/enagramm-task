...
const DesktopHeader = () => {
  return (
    <>
      <div className="relative hidden lg:block bg-[#132450] min-w-[240px] h-[100vh] px-[24px] pt-[45px]">
        <img className="absolute top-[12px] right-[27px]" src={ChevronLeft} alt="ChevronLeft" />
        ...
        <div className="flex flex-col gap-[34px] mt-[60px] text-[#FFFFFF]">
          <div className="flex items-center justify-start gap-[9px]">
            ...
            <span className="text-[14px]">მართლმწერი</span>
          </div>
          <div className="flex items-center justify-start gap-[9px] z-999">
            <img src={Spell} alt="Spell" width={24} height={24} />{" "}
            <span className="text-[#132450] text-[14px]">ტექსტის შედარება</span>
          </div>
          <div className="flex items-center justify-start gap-[9px]">
            <img src={Mic} alt="Mic" width={24} height={24} />{" "}
            <span className="flex gap-[4px] text-[14px]">
              ხმა <img src={ArrowRight} alt="ArrowRight" /> ტექსტი
            </span>
          </div>
          <div className="flex items-center justify-start gap-[9px]">
            <img src={AlignCenter} alt="AlignCenter" width={24} height={24} />{" "}
            <span className="flex gap-[4px] text-[14px]">
              ტექსტი <img src={ArrowRight} alt="ArrowRight" /> ხმა
            </span>
          </div>
          <div className="flex items-center justify-start gap-[9px]">
            <img src={Pdf} alt="Pdf" width={24} height={24} />{" "}
            <span className="text-[14px]">PDF კონვერტაცია</span>
          </div>
        </div>
        <img
          src={Fragment}
          alt="Fragment"
          className="absolute top-[164px] right-[0px]"
        />
